...
<body>
	<div class="container">  
	  <form id="contact" action="add-user" method="post">
	  	    @csrf
		    <h3>Thông Tin Tài Khoản</h3>
		    <fieldset>
		      <input name="ma_so" placeholder="User Indefine" type="number" required autofocus>
		    </fieldset>
		    <fieldset>
		    ...
		    <fieldset>
		      <input name="confirmPass" placeholder="Confirm Password" type="password" required>
		    </fieldset>
		    <fieldset>
